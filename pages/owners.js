        ...
        <div style={{ padding: '20px' }}>
         ...
         <ul>
          ...
          <table className="responsive-table">
            ...
            <tbody>
              <tr>
                <td data-label={t('tt_date')}>2026-08-15</td>
                <td data-label={t('tt_meeting_type')}>
                  {t('td_agm')}
                </td>
                <td data-label={t('tt_links')}>
                  <a href="/owners-docs/combined-2026-08-15-esp.pdf">Español</a>
                </td>
                <td data-label={t('tt_links')}>
              ...
              <tr>
                ...
                <td data-label={t('tt_links')}>
                  <a href="/owners-docs/2025-11-16 - Combined Summary - Esp.pdf">Español</a>
                  <div className="no-hay-text">Minutos completos no proporcionados aun</div>
                </td>
                <td data-label={t('tt_links')}>
                  <a href="/owners-docs/2025-11-16 - Combined Summary - Eng.pdf">English</a>
          ...
          <table className="responsive-table">
            ...
            <tbody>
              ...
              <tr>
                <td data-label={t('tt_date')}>2025-11-25</td>
                <td data-label={t('tt_notice')}>
                  Nueveo Jardinerio<br />New Gardner
                </td>
                <td data-label={t('tt_links')}>
